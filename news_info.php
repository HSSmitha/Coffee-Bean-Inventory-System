	...
	<div class="banner-1">  
			...
			<nav class="navbar navbar-default">
				<div class="container">
					<div class="navbar-header">
						...
						<h1><a href="index.php"><i class="fa fa-pagelines" aria-hidden="true"></i>Growing</a></h1>
					</div> 
		...
		<div class="banner-bottom">
			...
			<div class="w3ls-heading">
				...
				$id = $_GET['id'];
				include('dbcon.php'); 
				$sql = mysql_query("SELECT * FROM `news` WHERE n_id='$id'");
				$res = mysql_fetch_array($sql);
				?>
				<h2 class="h-two"><?php echo $res['title']; ?></h2>
				<br/>
			</div>
				<div class="rows">
					<?php
					...
					$res = mysql_fetch_array($sql);
						...
						<div class="col-md-12">
							<div class="col-lg-5">
							<img src="admin/news_image/'.$res['image'].'" alt=" " class="img-responsive" id="news_info"/>
							</div>
							<div class="col-lg-7">
	...
	<div class="footer-agile">
		<div class="container">
			...
			<div class="copy-right"> 
				<p>© 2018 Growing . All rights reserved | Design by H.S.Smitha and Sinchana K.V.</p>
			</div>
		</div>
	</div> 
