				...
				<div class="container">
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<ul class="nav navbar-nav navbar-left"> 
							...
							<li><a href="gallery.php" class="btn w3ls-hover  active">Gallery</a></li>
					...
					while($res = mysql_fetch_array($sql))
					{
						...
						<div class="col-md-3 agileinfo_portfolio_grid">
							<div class="w3_agile_portfolio_grid1">
								<a href="admin/images/'.$res['image'].'" class="showcase" data-rel="lightcase:myCollection:slideshow" title="'.$res['type_beanname'].'">
									<div class="agileits_portfolio_sub_grid agileits_w3layouts_team_grid">	
										<div class="w3layouts_port_head">
											<h3>'.$res['type_beanname'].'</h3>
										</div>
										<img src="admin/images/'.$res['image'].'" alt=" " class="img-responsive" id="img-gal"/>
									</div>
								</a>
							</div>
						</div>
