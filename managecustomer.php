...
<head>
	<title>customer view</title>
          ...
          <li class="active"><a href="managecustomer.php">View Customer</a></li>
	...
	href="delete_cust.php?delete=<?php echo $editid;?>">Delete</a></td>
	<?php
	if($status == 'Active')
	{
		echo'
		<td><a href="custblock.php?id='.$row[0].'&&status=block" class="btn btn-warning">Block</a></td>
		';
	}
	else
	{
		echo'
		<td><a href="custblock.php?id='.$row[0].'&&status=unblock" class="btn btn-info">UnBlock</a></td>
		';
	}
	?>
	</tr>
